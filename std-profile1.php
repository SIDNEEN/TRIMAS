                ...
                <aside class="sidebar">
                    <div class="sidebar-container">
                        ...
                        <nav class="menu">
                            ...
                            <li>
                                    <a href="">
                                        <i class="fa fa-building-o"></i> ก่อนฝึกงาน <i class="fa arrow"></i>
                                    </a>
                                ...
                                <li>
                                    <a href="">
                                        <i class="fa fa-building-o"></i> ระหว่างฝึกงาน <i class="fa arrow"></i>
                                    </a>
                                    <ul class="sidebar-nav">
                                <li>
                                    <a href="std-4week.php">
                                        <i class="fa fa-user"></i>ข้อมูล4สัปดาห์เเรก </a>
                                </li>
                            </ul>
                            <li>
                                    <a href="">
                                        <i class="fa fa-building-o"></i> หลังฝึกงาน <i class="fa arrow"></i>
                                    </a>
                                    <ul class="sidebar-nav">
                                    <li class="active">
                                    <a href="std-pramern.php">
                                        <i class="fa fa-user"></i>นักศึกษาประเมินสถานประกอบการ</a>
                                </li>
                        </nav>
                    </div>
                            ...
                            <div class="col-xl-9 col-lg-8">
                                ...
                                <div class="tab-header">
                                    <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#address" role="tab">ข้อมูลที่พักของนักศึกษา</a>
                                            <div class="slide"></div>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="card card-primary">
                                                    ...
                                                    <div class="card-body">
                                                        <span class="font-weight-bold float-left" id="gpa">
                                                            <?php echo $gpa;?> </span>
                                                        ...
                                                        <button class="btn btn-sm btn-warning float-right" onclick="gpaFun()" id="btn-gpa"
                                                            name="editgpa">แก้ไข</button>
                                                    </div>
                                                    <!-- end of card-block -->
                                                </div>
                                                <!-- end of card -->
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card card-primary">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <span class="font-weight-bold float-left" id="comtest">
                                                            <?php echo $comtest;?> </span>
                                                        <button class="btn btn-sm btn-warning float-right" onclick="comtestFun()"
                                                            id="btn-comtest" name="editcomtest">แก้ไข</button>
                                                        <form id="comtestform" action="upd_stdprofile.php" method="post" enctype="multipart/form-data" style="display:none"
                                                            class="form-inline">
                                                            <input type="hidden" name="stdID" value="<?php echo $row['stdID'];?>">
                                                            ...
                                                            <!-- <br> -->
                                                            <button type="submit" class="btn btn-sm btn-success" name="editcomtest">บันทึก</button>
                                                        </form>
