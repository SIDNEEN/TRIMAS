    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <article class="content admin-compTable-page">
                                ...
                                <?php
                                    ...
                                    if(mysqli_num_rows($result)>0){
                                        ...
                                        while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            echo'   <button class="btn btn-warning btn-sm details-control" id="',$row["companyID"],'" booking-id="'.$row["openBookingID"].'" clicker="admin">ดูผู้จอง</button></td>';
