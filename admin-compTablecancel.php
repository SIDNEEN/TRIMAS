                    ...
                    <section class="section">
                        ...
                        <nav>
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" href="admin-compTablecancel.php">รอการตรวจสอบ</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="admin-compTablecanceldone.php">ตรวจสอบแล้ว</a>
                                </li>
                            </ul>
                        </nav>
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    while($row=mysqli_fetch_assoc($result)){
                                        ...
                                        echo '<td><button class="btn btn-sm btn-success btnAprrove"stdID="'.$row["stdID"].'" bookedID="'.$row["bookedID"].'"companyID="'.$row["companyID"].'"reason="'.$row["reason"].'" aprrover="'.$adminName.'" >อนุมัติ</button>
                                        <button class="btn btn-danger btn-sm btnnotAprrove"stdID="'.$row["stdID"].'" bookedID="'.$row["bookedID"].'"companyID="'.$row["companyID"].'"reason="'.$row["reason"].'" aprrover="'.$adminName.'">ไม่อนุมัติ</button></td>';
                                        print"</tr>\n";
                                    }
                                    }else{
