                ...
                <article class="content std-klankrong-info-page">
                    <section class="section">
                        ...
                        <ol class="breadcrumb text-success">
                            <span>คุณได้ส่งกลั่นกรองสถานประกอบการแล้ว</span>
                        </ol>
                        <?php
                            $sql = "SELECT COUNT(stdID) AS total FROM stdklankrong WHERE stdID=$stdID";
                            $resulte = $conn->query($sql);
                            if($resulte->num_rows > 0){
                                $rw = $resulte->fetch_assoc();
                                $total= $rw['total'];
                            }
                        ?>

                        <h3 class="text-center">กลั่นกรองสถานประกอบการ ครั้งที่  <?php echo $total;?></h3><br>
                       
                        <div class="detail row">
                            <div class="col-lg-6 fist-student">
                                ...
                                <div class="detail">
                                    ...
                                    if($resulte->num_rows > 0){
                                        ...
                                        if($rw['approve']=='waiting'){
                                            ...
                                            $footer='<a class="btn btn-success" href="std-klankrong.php" role="button">ส่งกลั่นกรองใหม่</a>';
