    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <article class="content staff-report-page">
                    <section class="section">
                        ...
                        <div class="card xs-12 mx-auto">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable-report" width="100%" cellspacing="0">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th>เบอร์โทรศัพท์</th>
                                            <th>แผนกที่ฝึกงาน</th>
                                            <th>ลักษณะงานที่ได้รับมอบหมาย</th>
                                            <th>ชื่อผู้ติดต่อ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while($row=mysqli_fetch_assoc($result)){     
                                            ...
                                            <td><b>'.$row["companyAddress"].'</b> แขวง/ตำบล <b>'.$row["companyTambol"].'</b> เขต/อำเภอ <b>'.$row["companyAmpo"].'</b> จังหวัด <b>'.$row["companyChangwat"].'</b> รหัสไปรษย์ณี <b>'.$row["companyZipCode"].'</b></td>
                                            <td class="text-center">'.$row["companyChangwat"].'</td>
                                            <td>'.$row["companyPhonet"].'</td>
