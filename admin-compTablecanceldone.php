    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <article class="content admin-compTablecancel-page">
                    <section class="section">
                        ...
                        <nav>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="admin-compTablecancel.php">รอการตรวจสอบ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  active" href="admin-compTablecanceldone.php">ตรวจสอบแล้ว</a>
                            </li>
                            <!-- <li class="nav-item">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php
                                    require_once('conn_mysql.php');
                                    $sql = "SELECT * FROM canceldone 
                                    LEFT JOIN student_data ON canceldone.stdID = student_data.stdID  
                                    LEFT JOIN company ON company.companyID = canceldone.companyID 
                                    ...
                                    if(mysqli_num_rows($result)>0){
                                        while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            if ($row['major']=="icm") {
                                                echo"<td>ICM</td>";
                                            }elseif ($row['major']=="ecm") {
                                                echo"<td>ECM</td>";
                                            }
                                            // echo"<td>".$row['major']."</td>";
                                            echo"<td>".$row['companyName']."</td>";
                                            echo"<td>".$row['aprrover']."</td>";
                                            if ($row["approve"]=='yes') {
                                                $approve = 'class="text-success">อนุมัติ';
                                            }else {
                                                $approve = 'class="text-danger">ไม่อนุมัติ';
                                            }
                                            echo '<td '.$approve.'</td>';
                                            echo '<td class="faq-table-btn">
                                                    <button type="button" class="btn btn-success btn-oval waves-effect waves-light"
                                                        data-toggle="modal" data-target="#cancelresaon'.$row['stdID'].'" data-placement="top" title="ดู">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                </td>';
                                            echo '<td>'.$row["datecancel"].'</td>';
                                            print"</tr>\n";
                                            ?>

                                            <!-- modal reason cancel -->
                                            <div class="modal fade" id="cancelresaon<?php echo $row['stdID'] ;?>" tabindex="-1" role="dialog" aria-labelledby="cancelresaonLabel" aria-hidden="true">
