    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <article class="content admin-qualify-page">
                                    ...
                                    if(mysqli_num_rows($result)>0){
                                        while($row=mysqli_fetch_assoc($result)){     
                                            ...
                                            if ($row["progress"]=='none') {
                                                echo '<td><button type="button" id="btn-checked'.$row["klankrongID"].'" class="btn btn-primary btn-block dropdown-toggle " data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ยังไม่ส่งหนังสือ</button>';
                                            }elseif($row["progress"]=='send') {
                                                echo '<td><button type="button" id="btn-checked'.$row["klankrongID"].'" class="btn btn-warning btn-block dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> รอการตอบรับ </button>';
                                            }elseif($row["progress"]=='accept') {
                                                echo '<td><button type="button" id="btn-checked'.$row["klankrongID"].'" class="btn btn-success btn-block dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> ตอบรับแล้ว </button>';
                                            }elseif($row["progress"]=='reject') {
                                                echo '<td><button type="button" id="btn-checked'.$row["klankrongID"].'" class="btn btn-danger btn-block dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> ตอบปฏิเสธ </button>';
                                            }
                                            echo ' <div class="dropdown-menu">
                                                    <a class="dropdown-item btn-send" href="#" klankrong-id="'.$row["klankrongID"].'">รอการตอบรับ</a>
                                                    <a class="dropdown-item btn-accept" href="#" klankrong-id="'.$row["klankrongID"].'">ตอบรับแล้ว</a>
                                                    <a class="dropdown-item btn-reject" href="#" klankrong-id="'.$row["klankrongID"].'">ตอบปฏิเสธ</a>
                                                </div>';
