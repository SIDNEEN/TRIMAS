                ...
                <article class="content admin-mngdatastd-page">
                    <section class="section">
                        ...
                        <div class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">จัดการข้อมูลคณะกรรมการ</li>
                        </div>
                        <div class="card card-primary">
                            <div class="card-header">
                                <div class="header-block">
                                    <p class="title text-white">ข้อมูลคณะกรรมการ</p>
                                </div>
                            </div>
                            <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <?php
                                    ...
                                    $sql="SELECT*FROM board_data ORDER BY boardID";
                                    $result=mysqli_query($conn,$sql)or die("Query failed");
                                    if(mysqli_num_rows($result)>0){
                                        while($row=mysqli_fetch_assoc($result)){
                                            $boardNumber = $row["boardID"];
                                            $boardFirstname = $row["boardFirstname"];
                                            $boardLastname = $row["boardLastname"];
                                            $boardRegisdate = $row['boardRegisdate'];
                                            echo '<tr>
                                            <td>'.$boardNumber.'</td>
                                            <td>'.$boardFirstname.'  '.$boardLastname.'</td>
                                            <td>'.$boardRegisdate.'</td>
                                            </tr>';
