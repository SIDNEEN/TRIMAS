    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <article class="content board-mngdatastd-page">
                                ...
                                <?php
                                    ...
                                    if(mysqli_num_rows($result)>0){
                                        while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            <td class="text-center"><a href="board-studentprofile.php?stdNumber='.$stdNumber.'">'.$stdNumber.'</a></td>
                                            <td><a href="board-studentprofile.php?stdNumber='.$stdNumber.'">'.$stdFirstname.'  '.$stdLastname.' </a></td>
                                            <td>'.$stdmajor.'</td>
