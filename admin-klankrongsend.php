                    ...
                    <section class="section">
                        ...
                        <div class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="admin-klankrong-waiting.php">กลั่นกรองสถานประกอบการ</a>
                            </li>
                                    ...
                                    <?php
                                        ...
                                        if($result2->num_rows >1){  
                                            ...
                                            while($row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC)){
                                                ...
                                                echo '<td>';
                                                if ($row2['majorID']==1) {
                                                    echo ' <a href="admin-klankrongsend.php?klankrongID='.$row2['klankrongID'].'">'.$row2['stdFirstname'].' '.$row2['stdLastname'].'</a></td>';
                                                    echo '<td>ICM</td>';
                                                    if ($row2['approve']=='yes') {
