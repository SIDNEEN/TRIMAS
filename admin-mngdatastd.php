    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <article class="content admin-mngdatastd-page">
                    <section class="section">
                        ...
                        <div class="card-block">
                                    ...
                                    <form role="form">
                                        <div class="row form-group">
                                            <div class="col-3 text-right">
                                                <label for="term" class="col-form-label">ภาคการศึกษา</label>
                                            </div>
                                            <div class="col-3">
                                            <select class="form-control xs-4" id="stdterm" onchange="show()">
                                                <?php
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover display nowrap" id="dataTable-studinfo" width="100%" cellspacing="0">
                                ...
                                <?php
                                    include('conn_mysql.php');
                                    $sql="SELECT*FROM student_data LEFT JOIN studentcomgpa ON student_data.stdID=studentcomgpa.stdID 
                                            LEFT JOIN major ON student_data.majorID=major.majorID 
                                            LEFT JOIN semester ON student_data.semesterID=semester.semesterID 
                                            ORDER BY stdNumber";
                                    $result=mysqli_query($conn,$sql)or die("Query failed");
                                    if(mysqli_num_rows($result)>0){
                                        while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            <td class="text-center"><a href="admin-studentprofile.php?stdNumber='.$stdNumber.'">'.$stdNumber.'</a></td>
                                            <td><a href="admin-studentprofile.php?stdNumber='.$stdNumber.'">'.$stdFirstname.'  '.$stdLastname.' </a></td>
                                            <td>'.$stdmajor.'</td>
                                            <td class="text-center">'.$gpa.'</td>
                                            <td class="text-center">'.$row["year"].'/'.$row["term"].'</td>
                                            </tr>';
                                    ...
                                    print"</table>\n";
                                    echo"จำนวนนักศึกษาทั้งหมด :",mysqli_num_rows($result),"คน<br>";
