                    ...
                    ?>
                        <div class="main">
                            ...
                            <div class="klankron-container">
                                <div class="kk-header"><h3 class="kk-text"><b>กลั่นกรองสถานประกอบการ</b></h3></div>
                                        ...
                                        <div>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="fieldset-content" style="<?php echo $display ;?>">
                                                    <div class="form-group">
                                                        <label for="department" class="form-label">แผนกที่ฝึกงาน</label>
                                                        <input type="text" name="department" id="department"required />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="workdetail" class="form-label">ลักษณะงานที่ได้รับมอบหมาย</label>
                                                        <textarea name="workdetail" id="workdetail" rows="4" cols="94" class="form-control" required></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pesoncont" class="form-label">ชื่อผู้ติดต่อ</label>
                                                        <input type="text" name="pesoncont" id="pesoncont"required />
                                                    </div>
                                                    <div class="form-group">
