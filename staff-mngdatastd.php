                                ...
                                <?php
                                    ...
                                    if(mysqli_num_rows($result)>0){
                                        while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            <td class="text-center"><a href="staff-studentprofile.php?stdNumber='.$stdNumber.'">'.$stdNumber.'</a></td>
                                            <td><a href="staff-studentprofile.php?stdNumber='.$stdNumber.'">'.$stdFirstname.'  '.$stdLastname.' </a></td>
                                            <td>'.$stdmajor.'</td>
